      ...
      <div>
        <div className="d-flex flex-column">
          ...
          <div className="lecture-detail">
            ...
            <p>　『詩学』第一章から第九章までの範囲の講義を行います。まずは、受講者の方々がSlackに投稿した論点や疑問点を踏まえたうえで、今回の講読範囲の要点をまとめます。さらに、批判的読解をするうえで見逃すことのできない次の論点を提示して、受講者の皆さまと議論を深めたいと思います。その論点とは、「模倣」と「人間の本性」をめぐるものです。</p>
            ...
            <p><b>第四回(12月20日 11:00-12:45)</b></p>
