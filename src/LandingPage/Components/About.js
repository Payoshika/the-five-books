...
const About = () => {
  ...
  <div className="about d-flex align-contents-center justify-content-center ">
    ...
    <div className="leader-info d-flex flex-column align-items-center justify-content-center">
      ...
      <p>大学卒業後スタートアップで海外市場開拓・営業に従事し、インド・フィリピンに赴任。その後、国際協力機構(JICA)で、アジア・東欧・中米の低所得者向け家計管理・金融サービス利用向上プロジェクトに携わる。<br/>2020年8月よりThe Five Booksを立ち上げる。好きな書籍は『生物から見た世界』(ユクスキュル著)、『道徳感情論』(アダム・スミス著)、『人倫の形而上学の基礎づけ』(エマニュエル・カント著)。
      </p>
    </div>
  </div>
