...
const About = () => {
  ...
  <div className="about d-flex align-contents-center justify-content-center ">
    <div className="leader-photo d-none d-md-flex flex-column align-items-center justify-content-center">
      <Image src={leaderphoto} rounded fluid alt="profile-photo"/>
    </div>
    <div className="leader-info d-flex flex-column align-items-center justify-content-center">
      <Image src={leaderphoto} className="d-block d-md-none"rounded fluid alt="profile-photo"/>
      <h4>事業責任者：大石 航平</h4>
  ...
  return(
    <Container fluid>　
      <Row>
        <Col>
          <h4 className="text-center">The Five Booksについて</h4>
          {content}
        </Col>
      </Row>
    </Container>
