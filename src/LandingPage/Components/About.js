...
const About = () => {
  ...
  <div className="about d-flex align-contents-center justify-content-center ">
    ...
    <div className="leader-info d-flex flex-column align-items-center justify-content-center">
      ...
      <p>日系スタートアップで海外市場開拓・営業に従事し、インド・フィリピンに赴任。その後、国際協力機構(JICA)で政府開発援助に携わり、アジア・アフリカ・中米の貧困層向け家計管理・金融サービス利用向上プロジェクトを実施。<br/>JICAを退職し、香港のプログラミングコース「Altcademy」を修了、The Five Booksを立ち上げる。愛読する古典は「生物から見た世界」、「道徳感情論」。
      </p>
    </div>
  </div>
