...
const ServiceFlow = () => {
  ...
  <div className="service-flow-img d-flex flex-column align-items-center justify-content-center bottom-border">
    <p>
      各自のペースで古典を読み進め、週に一度のオンライン講義を受けます。初回講義では、参加者は、講師から書籍の概略・背景について解説を受け、読み進める上で有益な前提情報を学び、講義の狙いや各講義の位置付けを理解します。
    </p>
    <p>
      開講期間中は、Slackの期間限定の読者グループへ招待します。参加者は、他の参加者と疑問点を共有したり、講師からの問いについて参加者同士で考えを共有・議論しながら、読みながら考え、考えてまた読んでいきます。また、講師は、読書グループに投稿される参加者の疑問や関心を踏まえた講義を行います。
    </p>
    <p>
