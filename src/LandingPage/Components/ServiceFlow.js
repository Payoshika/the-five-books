...
const ServiceFlow = () => {
  ...
  <div className="service-flow-img d-flex flex-column align-items-center justify-content-center bottom-border">
    ...
    <p>
      開講期間中は、Slackの期間限定の読者グループへ招待します。参加者は、他の参加者と疑問点を共有したり、講師からの問いについて参加者同士で考えを共有・議論する中で、読みながら考え、考えてまた読んでいきます。講師は、参加者の疑問や関心を踏まえた講義を行います。
    </p>
    <p>
      各講義には、質疑の時間を設け、読者はチャットまたは音声で質問することができます。読者と講師が十分に対話できるよう、講義の参加者は一度に最大30名としております。
    </p>
    <div>
