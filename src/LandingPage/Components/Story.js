...
const Story = () => {
  ...
  <div id="about" className="story d-flex flex-column align-items-center justify-content-center bottom-border">
    ...
    <p>
      一方で、古典には、用語や文脈・歴史背景の理解が不足していると理解できない箇所があることや、言い回しや論理構造の難解な箇所も多く、読み解くのに苦労することが多いのも確かです。<br/>また、周りに同じ本を読んでいる人を見つけるのが難しく、一人でその本と格闘することになってしまいます。
    </p>
    <p>
      The Five Booksは、専門家の講義を受け古典をより深く理解し、他の読者や自分自身と一緒に考えながら読むことで、古典の読書をより豊かな体験に変えていくことを目指しています。
    </p>
